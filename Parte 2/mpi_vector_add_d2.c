...
double Parallel_point_product(double local_x[], double local_y[], int local_n);
...

{
    ...
    Parallel_scalar_product(local_x, 2, local_z, local_n);

    printf("\n");

    Print_vector(local_z, local_n,  n, "Producto escalar x: ", my_rank, comm);

    Parallel_scalar_product(local_y, 2, local_z, local_n);

    printf("\n");
    
    Print_vector(local_z, local_n, n, "Producto escalar y: ", my_rank, comm);
...
double Parallel_point_product(double local_x[] /* in  */,
